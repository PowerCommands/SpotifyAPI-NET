...
using PainKiller.PowerCommands.SpotifyClientCommands;
using PainKiller.PowerCommands.SpotifyClientCommands.Configuration;
...
public static class Startup
{
    public static PowerCommandsManager ConfigureServices()
    {
        ...
        ConsoleService.Service.WriteHeaderLine(nameof(Startup),"\nYou need a spotify token to use the commands, navigate to the Spotify Console with this command:");
        ConsoleService.Service.WriteCodeExample(nameof(Startup),"token","");
