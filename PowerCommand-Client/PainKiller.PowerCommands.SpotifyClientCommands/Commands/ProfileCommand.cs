...
[PowerCommandDesign( description: "Search your locally stored play-lists, default search is on artist, album, title, playlist and tag (in short search all)",
                       arguments: "<search1> <search2> <search2> and so on...",
                         ...
                         example: "//Search your profile|profile \"Iron maiden\"|//search your playlist|profile party --playlist")]
public class ProfileCommand : SpotifyBaseCommando
{
    public ProfileCommand(string identifier, PowerCommandsConfiguration configuration) : base(identifier, configuration) { }
